  ...
  return (
    <section id="intro">
      <div className="introContent" data-aos="fade-up-right" data-aos-duration="1000">
        ...
        <p className="introPara">I am a passionate Web Developer currently pursuing my Bachelor's in IT Engineering (4th year). I specialize in front-end development and love building responsive, user-friendly websites using React, HTML, CSS, and JavaScript, react. Excited to explore new technologies and bring creative ideas to life!" </p>
